...
A dual-axis plot can be made using `lattice` graphics.  The code below was adapted from [The R Graph Gallary: Dual Y axis in R](https://r-graph-gallery.com/145-two-different-y-axis-on-the-same-plot.html
).  
